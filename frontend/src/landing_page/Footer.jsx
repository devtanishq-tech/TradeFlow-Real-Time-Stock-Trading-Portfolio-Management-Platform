      ...
      {links.map((link) => (
        <li key={link} className="mb-2">
          <a
            ...
            style={{ fontSize: "13.5px", color: "#888" }}
          >
            {link}
          </a>
        </li>
...
function Footer() {
  return (
    <>
      <style>{`
        .footer-link:hover { color: #387ed1 !important; }
        .footer-social-icon { color: #555; transition: color 0.2s; }
        .footer-social-icon:hover { color: #387ed1; }
        .footer-bottom-link { color: #888; text-decoration: none; font-size: 12px; }
        .footer-bottom-link:hover { color: #387ed1; text-decoration: underline; }
      ...
      <footer
        style={{ backgroundColor: "#f8f9fa", borderTop: "1px solid #e0e0e0" }}
      >
        <div className="container py-5">
          <div className="row g-4">
            ...
            <div className="col-12 col-md-6 col-lg-3">
              ...
              {/* Social Row 1: X, Facebook, Instagram, LinkedIn */}
              <div className="d-flex gap-3 mb-2">
                {[
                  {
                    label: "X (Twitter)",
                    d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z",
                  },
                  {
                    label: "Facebook",
              ...
              <hr
                style={{ width: "75%", marginLeft: 0, borderColor: "#bbb" }}
              />

              {/* Social Row 2: YouTube, WhatsApp, Telegram */}
          ...
          {/* ── Legal Disclaimer ── */}
          <div
            className="mt-5 pt-4 text-muted"
            style={{
              fontSize: "11px",
              lineHeight: "1.7",
          ...
          >
            <p>
              ...
              , for DP related to{" "}
              <a href="mailto:dp@zerodha.com" style={{ color: "#387ed1" }}>
                dp@zerodha.com
              </a>
          ...
          <div
            ...
            style={{ borderTop: "1px solid #e0e0e0", fontSize: "12px" }}
          >
